...
PreparedStatement pst=null;
    ...
    public PatientRegistrationRecord(String PatientID,String PatientName,String Fathername,String Address,String Age,String EmailID,String ContactNo,String Gen,String BG) {
 ...
 private void Get_Data(){
           String sql="select PatientID as 'Patient ID', PatientName as 'Patient Name',FatherName as 'Father Name',Address,ContactNo as 'Contact No',Email as 'Email ID',Age,Gen as 'Gender',BG as 'Blood Group',Remarks from Patientregistration"
           		+ " where PatientID like '%" + txtPatientID + "%' and"
           		+ " PatientName like '%" + txtPatientName + "%' and "
