 ...
 private void Reset()
{
    ...
    private void btnGetDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGetDataActionPerformed
     this.hide();
     ServicesRecord frm= new ServicesRecord(txtServiceName.getText(),txtServiceDate.getText(),txtPatientID.getText(),txtServiceCharges.getText(),txtServiceID.getText());
     frm.setVisible(true);
