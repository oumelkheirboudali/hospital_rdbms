...
PreparedStatement pst=null;
    ...
    public ServicesRecord(String ServiceName,String ServiceDate,String PatientID,String ServiceCharges,String ServiceID) {
    	txtServiceName=ServiceName;
    	txtServiceDate=ServiceDate;
    	txtPatientID=PatientID;
    	txtServiceCharges=ServiceCharges;
 ...
 private void Get_Data(){
       String sql="select ServiceID as 'Service ID', ServiceName as 'Service Name',ServiceDate as 'Service Date',p.PatientID as 'Patient ID',PatientName as 'Patient Name',ServiceCharges as 'Service Charges' from PatientRegistration p,Services s where s.PatientID=p.PatientID "
       		+ " and s.ServiceID like '%" + txtServiceID + "%'"
       		+ " and s.ServiceDate like '%" + txtServiceDate + "%'"
       		+ " and s.PatientID like '%" + txtPatientID + "%'"
       		+ " and s.ServiceCharges like '%" + txtServiceCharges + "%'"
       		+ " and s.ServiceName like '%" + txtServiceName + "%'"
   ...
   frm.setVisible(true);
    ...
    String txtServiceCharges;
    String txtServiceDate;
    String txtServiceID;
