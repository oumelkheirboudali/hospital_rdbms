...
PreparedStatement pst=null;
    ...
    public PatientDischargeRecord_Ward1(String did, String dis,String date, String WardName) {
    	txtDoctorID=did;
    	txtDisease=dis;
 ...
 private void Get_Data(){
         try{
             String sql="Select Ward.ID as 'Discharge ID', AdmitPatient_Ward.AdmitID as 'Admit ID',"
             		...
             		+ "Disease,AdmitDate as 'Admit Date',Ward.Wardname as 'Ward Name',"
             		...
             		+ "from Ward,Doctor,PatientRegistration,AdmitPatient_Ward,DischargePatient_Ward "
             		+ "where Ward.Wardname=AdmitPatient_Ward.Wardname "
             		+ "and Doctor.DoctorID=AdmitPatient_Ward.DoctorID "
