...
PreparedStatement pst=null;
    ...
    public PatientAdmit_WardRecord(String did, String dis,String date, String WardName) {
...
private void Get_Data(){
          try{
              String sql="Select AdmitID as 'Admit ID',PatientRegistration.PatientID as 'Patient ID',PatientRegistration.PatientName as 'Patient Name',PatientRegistration.Gen as 'Gender',PatientRegistration.BG as 'Blood Group',"
              		+ "Disease,AdmitDate as 'Admit Date',Ward.Wardname as 'Ward Name',Doctor.DoctorID as 'Doctor ID',"
              		+ "DoctorName as 'Doctor Name',AdmitPatient_Ward.AP_Remarks as 'Remarks' "
              		+ "from Ward,Doctor,PatientRegistration,AdmitPatient_Ward "
              		+ "where Ward.Wardname=AdmitPatient_Ward.Wardname and Doctor.DoctorID=AdmitPatient_Ward.DoctorID"
		      		...
		      		+ " AdmitPatient_Ward.AdmitDate like '%" + txtAdmitDate + "%' and "
		      		+ " Ward.WardName like '%" + cmbWardName + "%'"+ " order by admitdate";
