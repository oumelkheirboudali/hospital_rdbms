...
PreparedStatement pst=null;
    ...
    public Nurse_WardBoyRecord(String ID,String Name,String Category,String EmailID,String ContactNo,String Qualifications,String BloodGroup,String DateOfJoining,String Address) {
    	txtID=ID;
    	txtName=Name;
 ...
 private void Get_Data(){
        String sql="select ID, W_N_name as 'Name',Category,Address,ContactNo as 'Contact No',Email as 'Email ID',Qualifications,BloodGroup as 'Blood Group',DateOfJoining as 'Joining Date' from Wardboy_Nurse_tbl "
        		+ " where ID like '%" + txtID + "%' and"
           		+ " W_N_name like '%" + txtName + "%' and "
           		+ " Category like '%" + cmbCategory + "%' and "
           		+ " Address like '%" + txtAddress+ "%' and "
           		+ " ContactNo like '%" + txtContactNo+ "%' and "
           		+ " Email like '%" + txtEmailID + "%' and "
           		+ " Qualifications like '%" + txtQualifications+ "%' and "
           		+ " BloodGroup like '%" + cmbBloodGroup + "%' and "
           		+ " DateOfJoining like '%" + txtDateOfJoining + "%'"
        		+ " order by W_N_name";
        try{
