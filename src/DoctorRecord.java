...
PreparedStatement pst=null;
    ...
    /*public DoctorRecord(String DoctorID,String DoctorName) {
    	txtDoctorID=DoctorID;
        txtDoctorName=DoctorName;
        initComponents();
         con= Connect.ConnectDB();
        GetFreeDocData();
        setLocationRelativeTo(null);
    }*/
    public DoctorRecord(String DoctorID,String DoctorName,String Fathername,String Address,String Qualifications,String Specialization,String EmailID,String ContactNo,String Gen,String BG, String DateOfJoining) {
    	txtDoctorID=DoctorID;
        txtDoctorName=DoctorName;
        txtFathername=Fathername;
        txtAddress=Address;
        txtQualifications=Qualifications;
        txtSpecialization=Specialization;
        txtEmailID=EmailID;
        txtContactNo=ContactNo;
        txtGen=Gen;
        txtBG=BG;
        txtDateOfJoining= DateOfJoining;
 ...
 private void Get_Data(){
      String sql="select DoctorID as 'Doctor ID', DoctorName as 'Doctor Name',FatherName as 'Father Name',"
	      		+ "Address,ContactNo as 'Contact No',Email as 'Email ID',Qualifications,"
	      		+ "Specialization,Gender,BloodGroup as 'Blood Group',DateOfJoining as 'Joining Date' from Doctor "
           		+ " where DoctorID like '%" + txtDoctorID + "%' and"
           		+ " DoctorName like '%" + txtDoctorName + "%' and "
           		+ " FatherName like '%" + txtFathername + "%' and "
           		+ " Address like '%" + txtAddress+ "%' and "
           		+ " ContactNo like '%" + txtContactNo+ "%' and "
           		+ " Qualifications like '%" + txtQualifications + "%' and "
           		+ " Specialization like '%" + txtSpecialization+ "%' and "
           		+ " Gender like '%" + txtGen + "%' and "
           		+ " Bloodgroup like '%" + txtBG + "%' and "
           		+ " DateOfJoining like '%" + txtDateOfJoining + "%'" + " order by DoctorName"; 
     try{
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
       try{
            ...
            if(rs.next()){
                ...
                frm.cmbBloodGroup.setText(add9);
                String add11=rs.getString("Gender");
                frm.cmbGender.setText(add11);
    ...
    String txtContactNo;
    String txtEmailID;
    String txtFathername;
    String txtDoctorID;
    String txtDoctorName;
    String txtQualifications;
    String txtSpecialization;
    String txtBG;
    String txtGen;
