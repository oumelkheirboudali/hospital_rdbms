...
PreparedStatement pst=null;
    ...
    public UsersRegistrationRecord(String a,String b,String c,String e) {
        txtContactNo=a;
        txtEmailID=b;
        txtName=c;
        txtUserName=e;
  ...
  private void Get_Data(){
        String sql="select NameOfUser as 'Name', UserName as 'User Name',Password,ContactNo as 'Contact No',Email as 'Email ID' from Registration"
        	+ " where NameOfUser like '%" + txtName + "%'"
       		+ " and UserName like '%" + txtUserName + "%'"
       		+ " and ContactNo like '%" + txtContactNo + "%'"
       		+ " and Email like '%" + txtEmailID + "%'";
        try{
