...
PreparedStatement pst=null;
    ...
    public PatientDischargeRecord_Ward(String did, String dis,String date, String WardName) {
    	txtDoctorID=did;
    	txtDisease=dis;
    	txtDischargeDate=date;
    	cmbWardName=WardName;
        initComponents();
 ...
 private void Get_Data(){
         try{
               String sql="Select Ward.ID as 'Discharge ID', AdmitPatient_Ward.AdmitID as 'Admit ID',"
               		...
               		+ "Ward.Wardname as 'Ward Name',Doctor.DoctorID as 'Doctor ID',DoctorName as 'Doctor Name',"
               		+ "DischargeDate as 'Discharge Date',DP_Remarks as 'Remarks' "
               		+ "from Ward,Doctor,PatientRegistration,AdmitPatient_Ward,"
               		+ "DischargePatient_Ward where Ward.Wardname=AdmitPatient_Ward.Wardname "
               		+ "and Doctor.DoctorID=AdmitPatient_Ward.DoctorID and "
               		+ "PatientRegistration.PatientID=AdmitPatient_Ward.PatientID  "
               		+ "and AdmitPatient_Ward.admitID= DischargePatient_Ward.admitID"
	        		+ " and PatientRegistration.PatientID like '%" + PatientID + "%' and "
	        		+ " Doctor.DoctorID like '%" + txtDoctorID + "%' and "
	        		+ " Disease like '%" + txtDisease+ "%' and "
	        		+ " DischargePatient_Ward.DischargeDate like '%" + txtDischargeDate + "%' and "
	        		+ " Ward.Wardname like '%" + cmbWardName + "%'"+ " order by Dischargedate";
