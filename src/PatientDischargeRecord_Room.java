...
PreparedStatement pst=null;
    ...
    public PatientDischargeRecord_Room(String pid,String did, String dis,String date,String room) {
    	PatientID=pid;
    	txtDoctorID=did;
    	txtDisease=dis;
 ...
 private void Get_Data(){
         try{
         String sql="Select dischargepatient_room.ID as 'Discharge ID', AdmitPatient_Room.AdmitID as 'Admit ID',"
         		+ "PatientRegistration.PatientID as 'Patient ID',PatientRegistration.PatientName as 'Patient Name'"
         		+ ",PatientRegistration.Gen as 'Gender',PatientRegistration.BG as 'Blood Group',Disease,"
         		+ "AdmitDate as 'Admit Date',Room.RoomNo as 'Room No',Doctor.DoctorID as 'Doctor ID',"
         		+ "DoctorName as 'Doctor Name',DischargeDate as 'Discharge Date',"
         		+ "DP_Remarks as 'Remarks' from Room,Doctor,PatientRegistration,AdmitPatient_Room,DischargePatient_Room "
         		...
         		+ " DischargePatient_Room.DischargeDate like '%" + txtDischargeDate + "%' and "
         		+ " Room.RoomNo like '%" + cmbRoomNo + "%'"+ " order by Dischargedate";
